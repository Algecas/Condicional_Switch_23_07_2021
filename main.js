let posicion = prompt(`Ingrese la posición del deportista en la competencia`);
var output = 'Salida: ';
switch (posicion) {
    case '1':
        output += 'Medalla de oro';
        console.log(output);
        break;
    case '2':
        output += 'Medalla de plata';
        console.log(output);
        break;
    case '3':
        output += 'Medalla de bronce';
        console.log(output);
        break;
    case false:
        output += 'No obtiene reconocimiento';
        console.log(output);
        break;
    default:
        console.log('No obtiene reconocimiento');
}
